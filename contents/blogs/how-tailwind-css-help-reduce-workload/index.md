...
<div id="notification">
  ...
  <div class="max-w-lg mx-auto flex p-6 bg-green-500 rounded-lg shadow-lg hover:shadow-2xl mb-10">
    ...
    <div class="ml-6 pt-1">
      <h4 class="text-xl text-white leading-tight mt-0 mb-1">Pesan Baru dari Bos</h4>
      <p class="text-base text-white leading-normal m-0">Bulan depan kamu saya angkat jadi CTO ya!</p>
    </div>
  </div>
  ...
  <div class="max-w-lg mx-auto flex p-6 bg-red-500 rounded-lg shadow-lg hover:shadow-2xl mb-10">
    ...
    <div class="ml-6 pt-1">
      <h4 class="text-xl text-white leading-tight mt-0 mb-1">Pesan Baru dari Bos</h4>
      <p class="text-base text-white leading-normal m-0">Cepat ke meja saya sekarang!</p>
    </div>
  </div>
</div>
