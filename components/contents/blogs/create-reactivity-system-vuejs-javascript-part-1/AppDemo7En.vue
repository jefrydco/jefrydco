      ...
      <script>
        ...
        const state7 = (function() {
          ...
          function main() {
            ...
            const stateDisplay = document.querySelector('.demo-card-7 .state')

            const resultDisplay = document.querySelector('.demo-card-7 .result')

            const input1Display = document.querySelector('.demo-card-7 .input1')
            const input2Display = document.querySelector('.demo-card-7 .input2')
