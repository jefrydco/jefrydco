      ...
      <script>
        ...
        const state4 = (function() {
          ...
          function main() {
            ...
            const stateDisplay = document.querySelector('.demo-card-4 .state')
            stateDisplay.innerText = JSON.stringify(state, null, 2)

            const resultDisplay = document.querySelector('.demo-card-4 .result')
            resultDisplay.innerText = state.result.toString()

            const input1Display = document.querySelector('.demo-card-4 .input1')
            const input2Display = document.querySelector('.demo-card-4 .input2')
