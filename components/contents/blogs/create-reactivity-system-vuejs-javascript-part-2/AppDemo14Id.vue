        ...
        let keadaan14 = (function() {
          ...
          function mulai() {
            ...
            const tampilanKeadaan = document.querySelector(
              '.demo-card-14 .keadaan'
            )

            const tampilanHasil = document.querySelector('.demo-card-14 .hasil')
