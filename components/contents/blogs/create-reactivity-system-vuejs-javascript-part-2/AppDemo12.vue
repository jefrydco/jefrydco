<template>
  <app-demo :path="DEFAULT_PATH" :name="$options.name">
    <div class="demo-card demo-card-12">
        ...
        const keadaan12 = (function() {
          ...
          function mulai() {
            ...
            const tampilanKeadaan = document.querySelector(
              '.demo-card-12 .keadaan'
            )

            const tampilanHasil = document.querySelector('.demo-card-12 .hasil')
            ...
            const tampilanTombolBerhenti = document.querySelector(
              '.demo-card-12 .berhenti'
            )
            const tampilanTombolReset = document.querySelector(
              '.demo-card-12 .reset'
            )
            const tampilanDetik = document.querySelector('.demo-card-12 .detik')
