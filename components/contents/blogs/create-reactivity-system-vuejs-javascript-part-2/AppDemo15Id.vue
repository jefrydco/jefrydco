<template>
  <app-demo :path="DEFAULT_PATH" :name="$options.name">
    <div class="demo-card demo-card-15">
        ...
        const keadaan15 = (function() {
          ...
          function mulai() {
            ...
            const tampilanKeadaan = document.querySelector(
              '.demo-card-15 .keadaan'
            )

            const tampilanHasil = document.querySelector('.demo-card-15 .hasil')
